...
DiscoverServerInterface::DiscoverServerInterface(const ::DiscoverRequest& request, ::DiscoverResponse& response)
  : m_request(request), 
  m_response(response) {

}

DiscoverServerInterface::~DiscoverServerInterface() {

}

void DiscoverServerInterface::run() {
  //
