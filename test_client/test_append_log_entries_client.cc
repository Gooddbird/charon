 ...
 *    #			###   #		  #				#				 #   #		#					####
 *
 * test_append_log_entries_client.cc
 * Generated by tinyrpc framework tinyrpc_generator.py
 * Create Time: 2022-11-13 17:18:42
...
void test_client() {
  ...
  tinyrpc::IPAddress::ptr addr = std::make_shared<tinyrpc::IPAddress>("0.0.0.0", 16666);
  ...
  ::AppendLogEntriesRequest rpc_req;
  ::AppendLogEntriesResponse rpc_res;

  std::cout << "Send to tinyrpc server " << addr->toString() << ", requeset body: " << rpc_req.ShortDebugString() << std::endl;
  stub.AppendLogEntries(&rpc_controller, &rpc_req, &rpc_res, NULL);
